			...
			<div class="col-xs-12 recipe_details text-center">
				...
				<div class="step">
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">Take care not to overcook the vegetables in 步骤 1. This meal can be served for breakfast with chapattis (or toast) or served for an elegant Indian-style brunch.
