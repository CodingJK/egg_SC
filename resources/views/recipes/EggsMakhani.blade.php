			...
			<div class="col-xs-12 recipe_details text-center">
				...
				<div class="step">
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">Be sure to cook chick-pea flour well during 步骤 1. The idea is to roast it in the pan until golden brown in colour, to release its nutty flavour.
