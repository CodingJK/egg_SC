...
@section('content')
	...
	<div class="recipes">
		...
		<div class="col-xs-12 header text-center">
			...
			<span class='recipe_title'>香葱玉米薄饼</span>
			<p class='title_body'>
					Chef Marysol Foucault 教你用鸡蛋炮制大厨级异国风味！这款薄饼是宴请挚亲好友的下午茶心意之选。
			</p>
			...
			<div class="col-xs-12 recipe_details text-center">
				...
				<div style='margin-bottom: 50px;'>
 				...
 				<div class="ingredients" style='clear: both'>
 					<div class='recipes_subtitle'>薄饼</div>
			...
			<div class="ingredients" style='clear: both'>
				...
				<div class="step">
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">将香葱打横切成4段，再切成1英寸长，放置备用。</div>
						<hr class='hr1'>
					</div>

					<div class="steps col-xs-12  text-center">
						<div class="step_title col-xs-12">步骤 2</div>
						<div class="col-xs-10 col-xs-offset-1 step_body">在大型搅拌碗中，混合面粉和青柠汁。加入冰水、酱油、是拉差酱和已打散的蛋液，拌匀。加入香葱、玉米和适量的盐，拌匀。
						</div>
							<hr class='hr1'>
					</div>
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">在碗中混合所有配料，备用。</div>
						<hr class='hr1'>
					</div>

					<div class="steps col-xs-12  text-center">
						<div class="step_title col-xs-12">步骤 5</div>
						<div class="col-xs-10 col-xs-offset-1 step_body">在薄饼铺上蔬菜和泡菜糊，即可食用。</div>
						<hr class='hr1'>
					</div>
