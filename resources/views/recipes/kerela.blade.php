		...
		<div class="container-fuild recipes_images">
			...
			<div class="col-xs-12  text-center desc">
				<ul class='container-fuild text-center'>
					...
					<li class='recipe_worlds'>准备时间： 35-40 min</li>
					<li><img src="/images/icons/soup-icon.png" alt=""></li>
					<li class='recipe_worlds'>烹调时间： 準備瑤柱60分钟+烹煮30分钟</li>
				</ul>
			</div>
			...
			<div class="col-xs-12 recipe_details text-center">
				...
				<div class="step">
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">用鍋煮滾2升水，水滾後小心放入裝有瑤柱的碗，加蓋隔水蒸60分钟，令瑤柱變軟
						</div>
							<hr class='hr1'>
					</div>
...
大碗內將鸡蛋4个、清鸡湯280毫升，和盐、糖各½茶匙攪勻，將蛋湯注入淺瓷碟，包上保鮮紙
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">將凍水2升倒入大鍋，放入淺瓷碟，用中火隔水蒸20分钟
</div>
						<hr class='hr1'>
					</div>
					<hr>					
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">起鑊熱油1茶匙，落入第4步中灼熟的豬肉碎、第3步的瑤柱絲、清鸡湯100毫升，用盐、糖各½茶匙和白胡椒粉¼茶匙調味，煮1分钟，用生粉½茶匙慢慢攪拌勾芡
</div>
						<hr class='hr1'>
					</div>
					<hr>	
